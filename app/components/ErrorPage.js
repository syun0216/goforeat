...
import GLOBAL_PARAMS, { _winHeight, _winWidth } from "../utils/global_params";
//styles
  ...
  return (
    <View style={[styles.loadingContainer, props.style]}>
      <View style={styles.inner}>
        <Image
          source={require("../asset/badnetwork.png")}
          style={styles.image}
          resizeMode="cover"
        />
        <View style={styles.infoText}>
          <Text style={styles.text1}>
            {I18n[language].common_tips.network_err}
          </Text>
          <Text style={styles.text2}>
            {I18n[language].common_tips.reload_again}
          </Text>
        </View>
      </View>
      <CommonBottomBtn
        style={{
          marginTop: GLOBAL_PARAMS.em(102 / 2),
          width: GLOBAL_PARAMS.em(549 / 2)
        }}
        clickFunc={() => errorToDo()}
      >
