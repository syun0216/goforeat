        ...
        <View style={FoodDetailsStyles.AddPriceView}>
          <View style={FoodDetailsStyles.AddPriceViewPriceContainer}>
            <Text
              ...
              style={FoodDetailsStyles.AddPriceViewPriceUnit}
            >
              HKD
            </Text>
            <Text
              allowFontScaling={false}
              style={FoodDetailsStyles.AddPriceViewPrice}
            >
              {item.price}
            </Text>
            <Text
              allowFontScaling={false}
              style={FoodDetailsStyles.AddPriceViewOriginPrice}
            >
              HKD {item.originPrice}
            </Text>
